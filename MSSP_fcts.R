...
HPY_MAB <- function(data,
  ...
  ## inputs: 
  ##  data = firs batch of observations 
  ## (a matrix where row are obs and columns are groups)
  ...
  prob_new_out = matrix(0, nrow = tot_iter, ncol = J)
